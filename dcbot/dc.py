...
class WebDriverContainer:
    def __init__(self) -> None:
        ...
        self.driver.implicitly_wait(SELENIUM_TIME_TO_WAIT_SECONDS)
    ...
    def find_element_by_id(self, id_: str):
        WebDriverWait(self.driver, SELENIUM_TIME_TO_WAIT_SECONDS) \
...
class DcBrowser:
    def __init__(self, web_driver_container: WebDriverContainer, dc_account: str, dc_password: str) -> None:
        self.web_driver_container = web_driver_container
        self.dc_account = dc_account
        self.dc_password = dc_password
